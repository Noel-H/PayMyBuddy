...
class MoneyTransactionServiceTest {
    ...
    void getMoneyTransactionListByUserAccountId_Should_Return_ExpectedResult() {
        ...
        moneyTransactionWithBankAccount.setDate(LocalDateTime.of(2022,03,15,16,1));
        ...
        moneyTransactionWithUserAccount.setDate(LocalDateTime.of(2022,03,15,16,0));
        ...
        MoneyTransactionDTO moneyTransactionDTO = new MoneyTransactionDTO(
                LocalDateTime.of(2022,03,15,16,1),
                "TESTIBAN",
                100.0,
                10.0,
                "table-success",
        ...
        MoneyTransactionDTO moneyTransactionDTO2 = new MoneyTransactionDTO(
                LocalDateTime.of(2022,03,15,16,0),
                "test2@test.test",
                500.0,
                10.0,
                "table-success",
